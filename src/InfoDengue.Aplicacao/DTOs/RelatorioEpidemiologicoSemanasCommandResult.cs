...
public class RelatorioEpidemiologicoSemanasCommandResult : List<RelaotorioEpidemiologicoSemanasItemCommandResult>
{
}

public class RelaotorioEpidemiologicoSemanasItemCommandResult
{
    /// <summary>
