...
public class RelatorioEpidemiologicoPorMunicipioCommandResult : List<RelatorioEpidemiologicoPorMunicipioItemCommandResult>
{
}

public class RelatorioEpidemiologicoPorMunicipioItemCommandResult
{
    /// <summary>
